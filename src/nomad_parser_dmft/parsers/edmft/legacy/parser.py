...
class LegacyEDMFTParser(BeyondDFTWorkflowsParser):
    ...
    def __init__(self):
        ...
        self.struct_parser = Wien2kStructParser()
    ...
    def parse_system(self, sec_run: Run):
        """Parses the system from the Wien2k *.struct file using Wien2k parsing class `Wien2kStructParser`.
